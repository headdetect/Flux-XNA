...
namespace FarseerPhysics.DebugView {
    ...
    public class DebugViewXNA : DebugViewBase, IDisposable {
        ...
        public void DrawAABB ( ref AABB aabb, Color color ) {
            ...
            DrawPolygon( verts, 4, color, true );
        }
        ...
        public void DrawShape ( Fixture fixture, Transform xf, Color color ) {
            switch ( fixture.ShapeType ) {
                ...
                case ShapeType.Polygon: {
                        ...
                        DrawSolidPolygon( _tempVertices, vertexCount, color, true );
                    }
                    break;
        ...
        public override void DrawPolygon ( Vector2[] vertices, int count, float red, float green, float blue, bool closed ) {
            DrawPolygon( vertices, count, new Color( red, green, blue ), closed );
        }

        public void DrawPolygon ( Vector2[] vertices, int count, Color color, bool closed ) {
        ...
        public void LoadContent ( GraphicsDevice device, ContentManager content ) {
            ...
            _font = content.Load<SpriteFont>( "fonts/fpsfont" );
